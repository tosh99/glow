...
export default function About() {
    const [faqs, set_faqs] = useState([
        ...
        },
        {
            ...
            desc: 'Yes we do have virtual consultation with Dr. Varshini Reddy, MD Dermatology which you can book  through \n' +
        ...
        },
        {
            ...
            desc: 'Once you consult with us, we will ship all the products to your address. You can also visit our sister website glow.shop and find all the products there. We have a curated range of brands and products that you can ' +
                'discover newer products to add to your routine.'
        },
        {
        ...
        },
        {
            ...
            desc: 'As a brand we are mindful of the environmental impact we have on our planet. To do our part, we have partnered with an eco-friendly company that makes our packaging using biodegradable and recyclable materials.' +
                        ...
                        faqs.map((item, index) => {
                            return <div className={styles.faq}>
                                <div className={styles.faqContent}>
                                    ...
                                    <img src={'/icons/common/down.svg'} onClick={() => {
