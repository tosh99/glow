...
export default function Home() {
    ...
    return (
        <Fragment>
                ...
                <div className={"inner " + styles.skinCarePhil}>
                    ...
                    <div className={styles.scRight}>
                        <div>
                            ...
                            <p>The identity you’re building.
            ...
            <div className={"outer " + styles.sayHelloOuter}>
                    ...
                    <div className={styles.shTop}>
                        ...
                        <div>
                            <p>With our boutique skin studios set up in Hyderabad and Chennai,
                                ...
                                Dr. Varshini Reddy.</p>
                            <header>Afterall selfcare is an expression of self-love.</header>
                        </div>
                    </div>
                ...
                <div className={"inner " + styles.skinCarePhil}>
                    ...
                    <div className={styles.scRight}>
                        <div>
                            ...
                            <p>Both the services and space are designed to transport you to a state of tranquility.
                            </p>
                        </div>
                            ...
                            rtl.map((item, index) => {
                                return (<Fragment>
                                    <div className={styles.slide}>
                                        <img src={'images/home/slider-' + (index + 1) + '.png'}/>
                                        <div>
                                            <h3>0{index + 1}</h3>
                ...
                <div className={"inner " + styles.skinCarePhil + ' ' + styles.glowEdit}>
                    ...
                    <div className={styles.scRight}>
                        <div>
                            ...
                            <p>Dr. Varshini Reddy started Glow as a skincare destination that could serve as a clinic, medispa and a rest stop for you to indulge in some self-care. Apart from being a dermatologist, she is also a skincare
                                enthusiast who is here to share all her clinical know-how and experience.
                                Let's cover our bases with all the basic information everyone just assumes you know. At Glow, we want to enlighten you so you can make an informed decision. A Holy-Glow-Grail to guide you on your journey to
