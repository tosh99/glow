    ...
    return (
        <Fragment>
            ...
            <ServicesComponent
                ...
                id={"getSetGlow"}
                content={
                    "Get Set Glow is your go-to choice for cleansing and detoxifying the liver to reveal a healthy, glowing skin and enhanced skin tone. Great for combating inflammation and flushes out toxins to rejuvenate your skin from within. Also good for when you’re feeling fatigued. <br><br>Purpose : Detox"
                }
            />
            <ServicesComponent
                srTitle={"GLUTA GLOW"}
