    ...
    return (
        <Fragment>
            ...
            <ServicesComponent
                ...
                id={"soinPeeling"}
                content={
                    "Rich in AHA, BHA and PHA, it exfoliates the epidermis to remove dead cells from the surface and to promote cell regeneration. A clinical procedure that smooths uneven areas\n" +
            ...
            <ServicesComponent
                ...
                id={"soinMasque"}
                content={
                    "The smoothing, unifying booster is formulated to help prevent premature aging of the skin, work on hyper-pigmentation and brighten the complexion. An exfoliating and regenerating protocol for keratinized Skin Instants and skin with an irregular micro-profile or textured skin. It evens out skin tone, leaving your face smooth and glowing."
                }
            />
            <ServicesComponent
                ...
                id={"soinBooster"}
                content={
                    "A treatment to detoxify and stimulate the epidermis and reoxygenate skin tissue, for dull Skin Instants asphyxiated by city pollution. This balancing facial is perfect for those who want refreshed and rejuvenated skin. A luxurious and balancing oxygen facial that features\n" +
            ...
            <ServicesComponent
                ...
                id={"doubleBooster"}
                content={
                    "After conducting a thorough analysis of your Skin Instants our Skin Expert will prescribe\n" +
            ...
            <ServicesComponent
                ...
                id={"remodellingFace"}
                content={
                    "Get brighter looking eyes, more pronounced cheekbones, fewer visible wrinkles and a clearly defined facial contour with Biologique Recherche’s innovative face sculpting, Remodeling Facial Machine. This state-of-the-art anti-aging\n" +
