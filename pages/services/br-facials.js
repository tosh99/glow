...
export default function BRFacials() {
    ...
    return (<Fragment>
            ...
            <ServicesComponent
                ...
                content={'Exclusively presenting to you Biologique Recherche — the leading dermo-cosmetic skincare brand born in Paris, ' +
            ...
            <ServicesComponent
                ...
                srDesc={''}
                content={'The smoothing, unifying booster is formulated to help prevent premature aging of the skin, work on hyper-pigmentation and brighten the complexion. An exfoliating and regenerating protocol for keratinized Skin Instants and skin with an irregular micro-profile or textured skin. It evens out skin tone, leaving your face smooth and glowing.'}/>
            <ServicesComponent
                srTitle={'SOIN BOOSTER VIP O2'}
                srDesc={''}
                content={'A treatment to detoxify and stimulate the epidermis and reoxygenate skin tissue, for dull Skin Instants asphyxiated by city pollution. This balancing facial is perfect for those who want refreshed and rejuvenated skin. A luxurious and balancing oxygen facial that features\n' +
            ...
            <ServicesComponent
                ...
                srDesc={''}
                content={'After conducting a thorough analysis of your Skin Instants our Skin Expert will prescribe\n' +
